...
def train():
    ...
    train_X, train_y, test_X, test_y = train_test_split(data_X, data_y, test_size=0.1, random_state=13)
    ...
    model.fit([train_X, train_y], train_y, 64, 1, 1, validation_data=(test_X, test_y))
